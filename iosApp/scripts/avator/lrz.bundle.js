! function(e) {
	...
	r.prototype.init = function() {
		...
		if(e.img = n, e.blob = i, e.canvas = r, !document.createElement("canvas").getContext) throw new Error("娴忚鍣ㄤ笉鏀寔canvas");
		return new o(function(t, r) {
			n.onerror = function() {
				throw new Error("鍔犺浇鍥剧墖鏂囦欢澶辫触")
			}, n.onload = function() {
				e._getBase64().then(function(e) {
					return e.length < 10 && r("鐢熸垚base64澶辫触"), e
				}).then(function(n) {
					t({
						origin: e.file,
						base64: n,
		...
		return new o(function(r) {
			a.getData(t, function() {
				e.orientation = a.getTag(this, "Orientation"), e.resize = e._getResize(), e.ctx = n.getContext("2d"), n.width = e.resize.width, n.height = e.resize.height, e.ctx.fillStyle = "#fff", e.ctx.fillRect(0, 0, n.width, n.height), s ? e._createBase64ForOldIOS().then(r) : e._createBase64().then(r)
			})
		})
		...
		return new r(e, t)
	}, window.lrz.version = "4.1.3", e.exports = window.lrz
}, function(e, t, n) {
	(function(t) {
		! function(n) {
			function r(e, t) {
			...
			var h = "function" == typeof t && t || function(e) {
					setTimeout(e, 1)
				},
	...
	(function() {
		...
		function d(e, t, n, r, i) {
			var o, a, s, u = e.getUint16(n, !i),
				c = {};
			for(s = 0; u > s; s++) o = n + 12 * s + 2, a = r[e.getUint16(o, !i)], !a && m && console.log("Unknown tag: " + e.getUint16(o, !i)), c[a] = f(e, o, t, n, i);
			return c
		}
		...
		function f(e, t, n, r, i) {
			...
			switch(h) {
				...
				case 4:
					...
					return a;
				case 5:
					if(1 == d) return c = e.getUint32(f, !i), l = e.getUint32(f + 4, !i), s = new Number(c / l), s.numerator = c, s.denominator = l, s;
					for(a = [], u = 0; d > u; u++) c = e.getUint32(f + 8 * u, !i), l = e.getUint32(f + 4 + 8 * u, !i), a[u] = new Number(c / l), a[u].numerator = c, a[u].denominator = l;
					return a;
				case 9:
